...
/** @type {string} */
const CACHE_VERSION = '1786105404|8648634704';
/** @type {string} */
const CACHE_PREFIX = 'NEON RUSH-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Godot.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Godot.html","Godot.js","Godot.offline.html","Godot.icon.png","Godot.apple-touch-icon.png","Godot.audio.worklet.js","Godot.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Godot.wasm","Godot.pck"];
